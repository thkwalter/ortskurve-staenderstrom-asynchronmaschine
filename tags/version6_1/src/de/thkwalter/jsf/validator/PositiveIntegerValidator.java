...
/**
 * Dieser {@link Validator} überprüft, ob die eingegebene ganze Zahl positiv ist.
 * 
 * @author Th. K. Walter
 */
 ...
 */
private static Logger logger = Logger.getLogger(PositiveIntegerValidator.class.getName());
...
public void validate(FacesContext facesContext, UIComponent uiComponent, Object object) throws ValidatorException
   ...
   if (wert <= 0)
      ...
      String fehlermeldung = "Der Wert der Größe " + label + " muss positiv sein! Die Größe hat jedoch den Wert: "
               + wert + ".";
      PositiveIntegerValidator.logger.log(Level.SEVERE, fehlermeldung);

      // Die Meldung für die Oberfläche und eine Ausnahme werden erzeugt und mit der Fehlermeldung für den Benutzer
      // initialisiert.
      String jsfMeldung = "Der Wert der Größe " + label
               + " muss positiv sein! Geben Sie bitte einen positiven Wert ein.";
